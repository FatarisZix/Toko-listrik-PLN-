...
$stmt = $pdo->prepare("
    SELECT b.*, c.name as customer_name, c.customer_number, c.tariff_type, c.user_id, 
           c.address, c.no_kwh, t.price_per_kwh, t.admin_fee as tariff_admin_fee
    FROM bills b
    ...
    <div class="struk-container">
        ...
        <div class="section">
            ...
            <div class="row">
                ...
                <span class="value" style="font-size: 0.8rem; margin-left: 10px;"><?= $bill['address'] ?></span>
            </div>
            <div class="row">
                <span class="label">NO KWH</span>
                <span class="value"><?= $bill['no_kwh'] ?? '-' ?></span>
            </div>
        </div>
