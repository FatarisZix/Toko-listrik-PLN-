...
<body>
    ...
    <div class="container">
        ...
        <p>Selamat datang, <?= $_SESSION['full_name'] ?>! 
            <?php if (!empty($customers) && isset($customers[0])): ?>
            (ID: <?= $customers[0]['customer_number'] ?>)
            <?php endif; ?>
                 Kelola pembayaran listrik Anda dengan mudah dan aman.
        </p>
        </div>
