...
if ($_POST) {
    ...
    $no_kwh = isset($_POST['no_kwh']) ? sanitizeInput($_POST['no_kwh']) : '';
    ...
    if (strlen($password) < 6) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("INSERT INTO customers (user_id, customer_number, name, address, tariff_type, power_capacity, no_kwh) VALUES (?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$user_id, $customer_number, $full_name, $address, $tariff_type, $power_capacity, $no_kwh]);
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="no_kwh" 
                                   placeholder="Masukkan No. KWH" required
                                   value="<?= isset($_POST['no_kwh']) ? htmlspecialchars($_POST['no_kwh']) : '' ?>">
                        </div>
                    </div>
